...
NotebookDataLength[    121756,       2531]
NotebookOptionsPosition[     94313,       1940]
NotebookOutlinePosition[    120598,       2501]
CellTagsIndexPosition[    120485,       2495]
WindowTitle->Quantum Circuit Implementing Grover's Search Algorithm
WindowFrame->Normal*)
...
Cell["Quantum Circuit Implementing Grover's Search Algorithm", "DemoTitle"],
...
$CellContext`matGrover[
          ...
          Append[
           ...
           "H", "X", "Z", "X", "H"}], {1, 1, 1, 1, 
          1}], $CellContext`initialMat[
          Pattern[$CellContext`n, 
           Blank[]]] := 
        Table[{"H"}, {$CellContext`n + 1}], $CellContext`mat01 = {{
          "H", "X", "C", "X", "H", "X", "C", "X", "H", "X", "C", "X", "H", 
           "X", "C", "X", "H"}, {
          "H", "X", "C", "X", "H", "X", "Z", "X", "H", "X", "C", "X", "H", 
           "X", "Z", "X", "H"}, {
...
$CellContext`matTransp = Transpose[$CellContext`mat]; $CellContext`col = 
           ...
           If[$CellContext`col > 1, $CellContext`matU1 = Apply[Dot, 
               Reverse[
                ...
                Map[$CellContext`gateColumn[#]& , $CellContext`matTransp, 
                 1]]], 
...
$CellContext`gateCZ[$CellContext`nq, $CellContext`p1, $CellContext`pc], 
            ...
            FreeQ[$CellContext`col, 
             "C"], $CellContext`matg = $CellContext`gateChoose[
               Part[$CellContext`col, 1]]; Do[$CellContext`matg = ArrayFlatten[
...
$CellContext`b1 = Table[
             ...
             IntegerDigits[$CellContext`j, 
              2, $CellContext`n], {$CellContext`j, 0, 2^$CellContext`n - 
              1}]; $CellContext`rules = Table[{FromDigits[
                 ReplacePart[
...
$CellContext`y2}}]}], Attributes[PlotRange] = {ReadProtected}}; 
      Typeset`initDone$$ = True); ReleaseHold[
       HoldComplete[{{
          HoldComplete[$CellContext`hadamardGate[
             Pattern[$CellContext`yy, 
              Blank[]], 
             Pattern[$CellContext`xx, 
              Blank[]]] := 
           Block[{$CellContext`x, $CellContext`y}, $CellContext`x = 
              ...
              0.1 (1 - $CellContext`yy); {
               ...
               Line[{{$CellContext`x + 
                  0.075, $CellContext`y}, {$CellContext`x + 
                  0.1, $CellContext`y}}], 
               ...
               Text[
                ...
                "H", 16, Bold], {$CellContext`x + 0.05, $CellContext`y - 
                 0.003}]}]], 
          HoldComplete[Null], 
          HoldComplete[$CellContext`gateX[
             Pattern[$CellContext`yy, 
              Blank[]], 
             Pattern[$CellContext`xx, 
              Blank[]]] := 
              ...
              0.1 (1 - $CellContext`yy); {
               ...
               Text[
                ...
                "X", 16, Bold], {$CellContext`x + 0.05, $CellContext`y - 
                 0.003}]}]], 
          HoldComplete[Null], 
          HoldComplete[$CellContext`gateZ[
             Pattern[$CellContext`yy, 
              Blank[]], 
             Pattern[$CellContext`xx, 
              Blank[]]] := 
           ...
           Block[{$CellContext`x, $CellContext`y}, $CellContext`x = 
              ...
              0.1 (1 - $CellContext`yy); {
               ...
               Line[{{$CellContext`x, $CellContext`y}, {$CellContext`x + 
                  0.1, $CellContext`y}}]}]], 
          HoldComplete[Null], 
          HoldComplete[$CellContext`controlC[
             Pattern[$CellContext`yy, 
              Blank[]], 
             Pattern[$CellContext`xx, 
              Blank[]]] := 
           Block[{$CellContext`x, $CellContext`y}, $CellContext`x = 
              ...
              0.1 (1 - $CellContext`yy); {{
                ...
                Line[{{$CellContext`x, $CellContext`y}, {$CellContext`x + 
                   0.1, $CellContext`y}}]}, {
                PointSize[0.015], 
                Point[{$CellContext`x + 0.05, $CellContext`y}]}}]], 
          HoldComplete[Null], 
          HoldComplete[$CellContext`targetN[
             Pattern[$CellContext`yy, 
              Blank[]], 
             Pattern[$CellContext`xx, 
              Blank[]]] := 
           Block[{$CellContext`x, $CellContext`y}, $CellContext`x = 
              ...
              0.1 (1 - $CellContext`yy); {{
                ...
                Line[{{$CellContext`x + 0.05, $CellContext`y - 
                   ...
                   0.017}}]}}]], 
          HoldComplete[Null], 
          HoldComplete[$CellContext`lineVert[
             Pattern[$CellContext`yy1, 
              Blank[]], 
             Pattern[$CellContext`yy2, 
              Blank[]], 
...
$CellContext`y2}}]}]], 
          HoldComplete[Null], 
          HoldComplete[$CellContext`circuit[
             PatternTest[
              Pattern[$CellContext`x, 
               Blank[]], MatrixQ]] := 
           Block[{$CellContext`inputMat, $CellContext`matTransp, \
...
$CellContext`qubits}]; $CellContext`obj = Table[
                Text[
                 ...
                 Part[$CellContext`qubitIn, $CellContext`j + 
                  1], {-0.05, (-0.1) $CellContext`j}], {$CellContext`j, 
                 0, $CellContext`q1}]; $CellContext`obj = 
              Join[$CellContext`obj, 
                Table[
                 Text[
                  Part[$CellContext`qubitOut, $CellContext`j + 1], {
                  0.1 $CellContext`col + 
              ...
              Transpose[$CellContext`inputMat]; 
             Do[$CellContext`column = 
                Part[$CellContext`matTransp, $CellContext`k2]; \
$CellContext`n1 = 0; If[
                 FreeQ[$CellContext`column, "C"], $CellContext`n2 = 
                 0, $CellContext`n2 = 1]; Do[$CellContext`bit = Which[
                    MatchQ[
                    ...
                    MatchQ[
                    Part[$CellContext`column, $CellContext`k1], "H"], 
                    $CellContext`hadamardGate[$CellContext`k1, \
$CellContext`k2], 
                    MatchQ[
                    Part[$CellContext`column, $CellContext`k1], "X"], 
                    $CellContext`gateX[$CellContext`k1, $CellContext`k2], 
                    ...
                    $CellContext`gateZ[$CellContext`k1, $CellContext`k2]]; \
$CellContext`obj = 
                  Join[$CellContext`obj, {$CellContext`bit}], \
{$CellContext`k1, $CellContext`qubits}]; If[$CellContext`n2 == 1, Do[
                   Which[
                    And[$CellContext`n1 == 0, 
                    MemberQ[{"C", "N"}, 
...
$CellContext`obj = Join[$CellContext`obj, 
               ...
               Graphics[$CellContext`obj], 
               PlotRange -> {{-0.12, 0.1 $CellContext`col + 
                  0.12}, {(-0.1) $CellContext`qubits + 0.05, 0.05}}, 
               AspectRatio -> Automatic, Frame -> True, FrameTicks -> None]]], 
          HoldComplete[Null], 
          HoldComplete[$CellContext`gateCN[
             Pattern[$CellContext`n, 
              Blank[]], 
             Pattern[$CellContext`kn, 
              Blank[]], 
...
$CellContext`b1 = Table[
                ...
                1, {$CellContext`j, 2^$CellContext`n}]; $CellContext`u0 = 
              SparseArray[$CellContext`rules, {
                2^$CellContext`n, 2^$CellContext`n}]; $CellContext`u0]], 
          HoldComplete[Null], 
          HoldComplete[$CellContext`gateCZ[
             Pattern[$CellContext`n, 
              Blank[]], 
             Pattern[$CellContext`kn, 
              Blank[]], 
...
$CellContext`b1 = Table[
          ...
          HoldComplete[$CellContext`matH = (1/2^Rational[1, 2]) {{1, 1}, {
              1, -1}}; $CellContext`matX = {{0, 1}, {1, 0}}; Null], 
          HoldComplete[Null], 
          
          HoldComplete[$CellContext`matZ = {{1, 0}, {
             0, -1}}; $CellContext`matI = {{1, 0}, {0, 1}}; Null], 
          HoldComplete[Null], 
          HoldComplete[$CellContext`gateChoose[
             Pattern[$CellContext`x, 
              Blank[]]] := Which[
             MatchQ[$CellContext`x, 1], $CellContext`matI, 
             MatchQ[$CellContext`x, "H"], $CellContext`matH, 
             MatchQ[$CellContext`x, "X"], $CellContext`matX, 
             MatchQ[$CellContext`x, "Z"], $CellContext`matZ]], 
          HoldComplete[Null], 
          HoldComplete[$CellContext`gateColumn[
             PatternTest[
              Pattern[$CellContext`col, 
               Blank[]], ListQ]] := 
           Block[{$CellContext`nq, $CellContext`p1, $CellContext`pc, \
...
$CellContext`gateCZ[$CellContext`nq, $CellContext`p1, $CellContext`pc], 
               ...
               Do[$CellContext`matg = ArrayFlatten[
                   Outer[Times, $CellContext`matg, 
                    ...
                    Part[$CellContext`col, $CellContext`j]]]], \
{$CellContext`j, 2, $CellContext`nq}]]; $CellContext`matg]], 
          HoldComplete[Null], 
          HoldComplete[$CellContext`matrixU[
             PatternTest[
              Pattern[$CellContext`mat, 
               Blank[]], MatrixQ]] := 
           Block[{$CellContext`matTransp, $CellContext`col, \
$CellContext`matU1}, $CellContext`matTransp = 
              Transpose[$CellContext`mat]; $CellContext`col = 
              Length[$CellContext`matTransp]; $CellContext`matU1 = 
              If[$CellContext`col > 1, $CellContext`matU1 = Apply[Dot, 
                  Reverse[
                   ...
                   Map[$CellContext`gateColumn[#]& , $CellContext`matTransp, 
                    1]]], 
                $CellContext`gateColumn[$CellContext`matTransp]]; \
$CellContext`matU1]]}, ($CellContext`initialMat[
             Pattern[$CellContext`n, 
              Blank[]]] := Table[{"H"}, {$CellContext`n + 1}]; 
          Null) ($CellContext`oracle[
             Pattern[$CellContext`n, 
              Blank[]], 
             Pattern[$CellContext`k, 
              Blank[]]] := If[0 <= $CellContext`k <= 2^$CellContext`n - 1, 
             Transpose[{
               ...
               Append[
                ReplaceAll[
                 IntegerDigits[$CellContext`k, 2, $CellContext`n], 0 -> "X"], 
                1]}]]; Null) ($CellContext`matW[
             Pattern[$CellContext`n, 
              Blank[]]] := Append[
             Append[
              Table[{"H", "X", "C", "X", "H"}, {$CellContext`n - 1}], {
              "H", "X", "Z", "X", "H"}], {1, 1, 1, 1, 1}]; 
          Null) ($CellContext`matGrover[
             Pattern[$CellContext`n, 
              Blank[]], 
             Pattern[$CellContext`k, 
              Blank[]]] := Join[
             $CellContext`oracle[$CellContext`n, $CellContext`k], 
             $CellContext`matW[$CellContext`n], 2]; 
          Null) ($CellContext`matModel[
             Pattern[$CellContext`n, 
              Blank[]], 
             Pattern[$CellContext`k, 
              Blank[]], 
...
Cell[TextData[{
 ...
 " is hidden in a black-boxed subroutine that indicates, when presented with \
any ",
 Cell[BoxData[
  FormBox["n", TraditionalForm]], "InlineMath"],
 "-bit integer ",
 ...
 Cell[BoxData[
  FormBox["n", TraditionalForm]], "InlineMath"],
 "-bit binary function. The function is implemented by the quantum circuit \
bounded by two dashed lines in the diagram. The problem is to find ",
 Cell[BoxData[
  FormBox["k", TraditionalForm]], "InlineMath"],
...
Cell[TextData[{
 "This Demonstration shows a quantum circuit implementing Grover's search \
algorithm that enables finding any given integer ",
 Cell[BoxData[
  FormBox["k", TraditionalForm]], "InlineMath"],
 " from the list ",
 Cell[BoxData[
...
",
 Cell[BoxData[
  FormBox[
   SubscriptBox["m", "opt"], TraditionalForm]], "InlineMath"],
 " times, where ",
 Cell[BoxData[
  FormBox[
   SubscriptBox["m", "opt"], TraditionalForm]], "InlineMath"],
...
Cell[TextData[{
 "Snapshot 1: Let a quantum memory register contain four qubits ",
 Cell[BoxData[
  FormBox[
   RowBox[{"(", 
    RowBox[{"n", "=", "3"}]}], TraditionalForm]], "InlineMath"],
 "): three qubits are originally prepared in the state |0\[RightAngleBracket] \
and one ancillary qubit is in the state |1\[RightAngleBracket]. Applying four \
Hadamard gates, one for each qubit, we obtain the equal superposition of all \
basis states of the four-qubit system. A quantum search subroutine bounded by \
two dashed lines in the diagram is a 3-bit binary function that outputs 1 if \
its input is some given integer, for example, ",
 Cell[BoxData[
  FormBox[
   RowBox[{"k", "=", "5"}], TraditionalForm]], "InlineMath"],
 " and 0 otherwise. This subroutine together with a quantum circuit drawn on \
the right of the dashed line form one Grover's iteration. The plot shows that \
after one iteration ",
 Cell[BoxData[
  FormBox[
   RowBox[{"(", 
    RowBox[{"m", "=", "1"}], ")"}], TraditionalForm]], "InlineMath"],
 " the probability of getting 5 as a result of measurement in the \
computational basis is equal to 88 percent. "
}], "DetailNotes",
 CellID->144772595],

Cell[TextData[{
 "Snapshot 2: The diagram demonstrates how the quantum circuit changes when \
one more Grover's iteration is added ",
 Cell[BoxData[
  FormBox[
   RowBox[{"(", 
    RowBox[{"m", "=", "2"}], ")"}], TraditionalForm]], "InlineMath"],
 ". After a second Grover's iteration a standard measurement in the \
computational basis gives 5 with probability 97 percent. "
}], "DetailNotes",
 CellID->688116996],

Cell[TextData[{
 "Snapshot 3: We do not add the third iteration in the diagram to avoid \
drawing a large quantum circuit; one can easily imagine how it will look. But \
after three iterations ",
 Cell[BoxData[
  FormBox[
   RowBox[{"(", 
    RowBox[{"m", "=", "3"}], ")"}], TraditionalForm]], "InlineMath"],
 " the probability of getting the correct result decreases to 57 percent. \
Thus, the maximum probability of getting the correct result is reached if the \
number of iterations is equal to its optimal value, which is determined as \
the integer part of ",
 Cell[BoxData[
  FormBox[
   RowBox[{"\[Pi]", "/", 
...
Cell[TextData[{
 "Similar simulations can be made for ",
 Cell[BoxData[
  FormBox[
 ...
 ". In all cases one can see that the optimal number of Grover's iterations \
gives the correct result with high probability. For a larger number of qubits \
the corresponding quantum circuits look similarly but calculations become \
more cumbersome and require more time. It should be emphasized that a similar \
search with a classical computer requires ",
 Cell[BoxData[
  FormBox[
   RowBox[{"O", 
    RowBox[{"(", "N", ")"}]}], TraditionalForm]], "InlineMath"],
 " applications of the subroutine while a quantum computer gives a quadratic \
speed-up. "
}], "DetailNotes",
 CellID->412820449],
...
Cell[TextData[{
 ButtonBox["Grover's Quantum Search Algorithm",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/GroversQuantumSearchAlgorithm/"], 
    None}],
 " (",
...
Cell[TextData[{
 ButtonBox["Simulated Quantum Computer Algorithm for Database Searching",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
SimulatedQuantumComputerAlgorithmForDatabaseSearching/"], None}],
 " (",
 ButtonBox["Wolfram Demonstrations Project",
  BaseStyle->"SiteLink",
  ButtonData->{
...
QuantumCircuitImplementingGroversSearchAlgorithm&version=0008"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
QuantumCircuitImplementingGroversSearchAlgorithm/\
QuantumCircuitImplementingGroversSearchAlgorithm-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Quantum Circuit Implementing Grover's Search Algorithm",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
QuantumCircuitImplementingGroversSearchAlgorithm/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
QuantumCircuitImplementingGroversSearchAlgorithm/"],
 "\"",
...
Cell[TextData[{
 "Contributed by: ",
 ButtonBox["Alexander Prokopenya",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Alexander+\
Prokopenya"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Alexander+Prokopenya"]
}], "Author",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[81620, 1618, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[81881, 1627, 691, 15, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[93491, 1915, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 120197, 2484},
 {"Copyright", 120393, 2489}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[618, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34949, 590, 75, 0, 70, "DemoTitle"],
Cell[35027, 592, 44403, 954, 70, "Output",
 CellID->129841372],
Cell[79433, 1548, 1052, 29, 70, "ManipulateCaption",
 CellID->920196459],
Cell[80488, 1579, 1129, 37, 70, "ManipulateCaption",
 CellID->23896918],
Cell[81620, 1618, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[81881, 1627, 691, 15, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[82575, 1644, 33, 0, 70, "DetailsSection"],
Cell[82611, 1646, 1173, 25, 70, "DetailNotes",
 CellID->144772595],
Cell[83787, 1673, 414, 10, 70, "DetailNotes",
 CellID->688116996],
Cell[84204, 1685, 1047, 30, 70, "DetailNotes",
 CellID->11918620],
Cell[85254, 1717, 990, 26, 70, "DetailNotes",
 CellID->412820449],
Cell[86247, 1745, 44, 0, 70, "RelatedLinksSection"],
Cell[86294, 1747, 440, 14, 70, "RelatedLinks",
 CellID->510377999],
Cell[86737, 1763, 487, 14, 70, "RelatedLinks",
 CellID->355441807],
Cell[87227, 1779, 4887, 91, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[92117, 1872, 45, 0, 70, "CitationSection"],
Cell[92165, 1874, 975, 27, 70, "Citations"],
Cell[93143, 1903, 345, 10, 70, "Author"],
Cell[93491, 1915, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature TRqoqlJkUqPJbvAnC2camcBl *)
